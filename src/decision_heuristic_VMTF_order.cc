...
DecisionHeuristicVMTForder::DecisionHeuristicVMTForder(QCDCL_solver& solver, bool no_phase_saving): DecisionHeuristic(solver), list_head(0), next_search(0), timestamp(0), overflow_queue(CompareVariables(decision_list)), no_phase_saving(no_phase_saving) {}

void DecisionHeuristicVMTForder::addVariable(bool auxiliary) {
...
void DecisionHeuristicVMTForder::notifyUnassigned(Literal l) {
...
void DecisionHeuristicVMTForder::notifyBacktrack(uint32_t decision_level_before) {
  backtrack_decision_level_before = decision_level_before;
  clearOverflowQueue();
}

Literal DecisionHeuristicVMTForder::getDecisionLiteral() {
...
void DecisionHeuristicVMTForder::resetTimestamps() {
...
void DecisionHeuristicVMTForder::moveToFront(Variable variable) {
...
bool DecisionHeuristicVMTForder::checkOrder() {
  Variable list_ptr = list_head;
